...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Beban Baru 😏, @user!\nTelah Di Grup @subject\n\n@desc'
  conn.bye = 'Akhirnya Kau Pergi Kau @user!'
  conn.spromote = '@user Lord Kita Dah Jadi Admin!'
  conn.sdemote = '@user Dia Sekarang Gay!'
